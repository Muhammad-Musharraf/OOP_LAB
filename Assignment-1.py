...
class number:
    ...
    def is_multiple(self):
        if self.m==0:
            ...
            print("N is not Multiple of M, 'False' ")
...
n1=find_min_max([1,4,6,0,8,12,3,2])
print(n1.min_max())
...
# Example usage
num = SumSquares(5)
print(num.sum_of_squares())   # Output: 30  (1² + 2² + 3² + 4²)
...
"""
5--->Give a single command that computes the sum from Exercise R-1.4, rely-
